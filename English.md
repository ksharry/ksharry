...
2. one of / each of 後面應接複數名詞。
3. 主詞後面的關代，一定要括號出來
4. 人物名詞 VS 事物名詞，應確認動詞的主詞或受詞是否為人物
###### 章節3(u不可數名詞/c可數名詞)
1. 不可數名詞是集合/概念/抽象名詞
2. 最常考的可數名詞1,言語或想法名詞的數以及地點名詞
3. 最常考的可數名詞2,問題/原因/努力/方法/建議/過程/目的/計畫/結果
4. 動名詞作為不可數名詞時，多半要是為單數形式
5. 考試中出現能可數/不可數的名詞purchase
6. 名詞多義詞use
###### 章節4
1. 複合名詞，前面名詞當形容詞用(beautiful girl)
2. 複合名詞，前面不用-s
###### 章節5
1. 人物/事物/可數/不可數
2. 商業名詞熟記業務主題
